...
void Vtestbench::traceInitThis__1(Vtestbench__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->declBit(c+537,"clock", false,-1);
        vcdp->declBit(c+545,"reset", false,-1);
        vcdp->declBus(c+553,"testbench MEM_ADDR_WIDTH", false,-1, 31,0);
        vcdp->declBit(c+537,"testbench clock", false,-1);
        vcdp->declBit(c+545,"testbench reset", false,-1);
        vcdp->declBit(c+201,"testbench trap", false,-1);
        vcdp->declBus(c+209,"testbench imem_addr", false,-1, 31,0);
        vcdp->declBus(c+1,"testbench imem_data", false,-1, 31,0);
        vcdp->declBus(c+217,"testbench x10", false,-1, 31,0);
        vcdp->declBus(c+561,"testbench out", false,-1, 31,0);
        vcdp->declBit(c+569,"testbench out_valid", false,-1);
        vcdp->declBus(c+9,"testbench cycles", false,-1, 31,0);
        vcdp->declBit(c+537,"testbench dut clock", false,-1);
        vcdp->declBit(c+545,"testbench dut reset", false,-1);
        vcdp->declBit(c+201,"testbench dut trap", false,-1);
        vcdp->declBus(c+217,"testbench dut x10", false,-1, 31,0);
        vcdp->declBus(c+209,"testbench dut imem_addr", false,-1, 31,0);
        vcdp->declBus(c+1,"testbench dut imem_data", false,-1, 31,0);
        vcdp->declBus(c+225,"testbench dut d_rd", false,-1, 4,0);
        vcdp->declBus(c+233,"testbench dut d_x0", false,-1, 31,0);
        vcdp->declBus(c+241,"testbench dut d_x1", false,-1, 31,0);
        vcdp->declBus(c+249,"testbench dut d_x2", false,-1, 31,0);
        vcdp->declBus(c+257,"testbench dut d_x3", false,-1, 31,0);
        vcdp->declBus(c+265,"testbench dut d_x4", false,-1, 31,0);
        vcdp->declBus(c+273,"testbench dut d_opcode", false,-1, 6,0);
        vcdp->declBit(c+17,"testbench dut illegalinsn", false,-1);
        vcdp->declBit(c+201,"testbench dut trapped", false,-1);
        {int i; for (i=0; i<32; i++) {
                vcdp->declBus(c+281+i*1,"testbench dut regfile", true,(i+0), 31,0);}}
        vcdp->declBus(c+209,"testbench dut pc", false,-1, 31,0);
        ...
        vcdp->declBit(c+577,"testbench dut alu_eq", false,-1);
...
void Vtestbench::traceFullThis__1(Vtestbench__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+193,(vlTOPp->testbench__DOT__dut__DOT__rfilewdata),32);
        vcdp->fullBit(c+201,(vlTOPp->testbench__DOT__dut__DOT__trapped));
        vcdp->fullBus(c+209,(vlTOPp->testbench__DOT__dut__DOT__pc),32);
        vcdp->fullBus(c+217,(vlTOPp->testbench__DOT__x10),32);
        vcdp->fullBus(c+225,(vlTOPp->testbench__DOT__dut__DOT__d_rd),5);
        vcdp->fullBus(c+233,(vlTOPp->testbench__DOT__dut__DOT__d_x0),32);
        vcdp->fullBus(c+241,(vlTOPp->testbench__DOT__dut__DOT__d_x1),32);
        vcdp->fullBus(c+249,(vlTOPp->testbench__DOT__dut__DOT__d_x2),32);
        vcdp->fullBus(c+257,(vlTOPp->testbench__DOT__dut__DOT__d_x3),32);
        vcdp->fullBus(c+265,(vlTOPp->testbench__DOT__dut__DOT__d_x4),32);
        vcdp->fullBus(c+273,(vlTOPp->testbench__DOT__dut__DOT__d_opcode),7);
        vcdp->fullBus(c+281,(vlTOPp->testbench__DOT__dut__DOT__regfile[0]),32);
        vcdp->fullBus(c+282,(vlTOPp->testbench__DOT__dut__DOT__regfile[1]),32);
        vcdp->fullBus(c+283,(vlTOPp->testbench__DOT__dut__DOT__regfile[2]),32);
        vcdp->fullBus(c+284,(vlTOPp->testbench__DOT__dut__DOT__regfile[3]),32);
        vcdp->fullBus(c+285,(vlTOPp->testbench__DOT__dut__DOT__regfile[4]),32);
        vcdp->fullBus(c+286,(vlTOPp->testbench__DOT__dut__DOT__regfile[5]),32);
        vcdp->fullBus(c+287,(vlTOPp->testbench__DOT__dut__DOT__regfile[6]),32);
        vcdp->fullBus(c+288,(vlTOPp->testbench__DOT__dut__DOT__regfile[7]),32);
        vcdp->fullBus(c+289,(vlTOPp->testbench__DOT__dut__DOT__regfile[8]),32);
        vcdp->fullBus(c+290,(vlTOPp->testbench__DOT__dut__DOT__regfile[9]),32);
        vcdp->fullBus(c+291,(vlTOPp->testbench__DOT__dut__DOT__regfile[10]),32);
        vcdp->fullBus(c+292,(vlTOPp->testbench__DOT__dut__DOT__regfile[11]),32);
        vcdp->fullBus(c+293,(vlTOPp->testbench__DOT__dut__DOT__regfile[12]),32);
        vcdp->fullBus(c+294,(vlTOPp->testbench__DOT__dut__DOT__regfile[13]),32);
        vcdp->fullBus(c+295,(vlTOPp->testbench__DOT__dut__DOT__regfile[14]),32);
        vcdp->fullBus(c+296,(vlTOPp->testbench__DOT__dut__DOT__regfile[15]),32);
        vcdp->fullBus(c+297,(vlTOPp->testbench__DOT__dut__DOT__regfile[16]),32);
        vcdp->fullBus(c+298,(vlTOPp->testbench__DOT__dut__DOT__regfile[17]),32);
        vcdp->fullBus(c+299,(vlTOPp->testbench__DOT__dut__DOT__regfile[18]),32);
        vcdp->fullBus(c+300,(vlTOPp->testbench__DOT__dut__DOT__regfile[19]),32);
        vcdp->fullBus(c+301,(vlTOPp->testbench__DOT__dut__DOT__regfile[20]),32);
        vcdp->fullBus(c+302,(vlTOPp->testbench__DOT__dut__DOT__regfile[21]),32);
        vcdp->fullBus(c+303,(vlTOPp->testbench__DOT__dut__DOT__regfile[22]),32);
        vcdp->fullBus(c+304,(vlTOPp->testbench__DOT__dut__DOT__regfile[23]),32);
        vcdp->fullBus(c+305,(vlTOPp->testbench__DOT__dut__DOT__regfile[24]),32);
        vcdp->fullBus(c+306,(vlTOPp->testbench__DOT__dut__DOT__regfile[25]),32);
        vcdp->fullBus(c+307,(vlTOPp->testbench__DOT__dut__DOT__regfile[26]),32);
        vcdp->fullBus(c+308,(vlTOPp->testbench__DOT__dut__DOT__regfile[27]),32);
        vcdp->fullBus(c+309,(vlTOPp->testbench__DOT__dut__DOT__regfile[28]),32);
        vcdp->fullBus(c+310,(vlTOPp->testbench__DOT__dut__DOT__regfile[29]),32);
        vcdp->fullBus(c+311,(vlTOPp->testbench__DOT__dut__DOT__regfile[30]),32);
        vcdp->fullBus(c+312,(vlTOPp->testbench__DOT__dut__DOT__regfile[31]),32);
        vcdp->fullBit(c+537,(vlTOPp->clock));
        vcdp->fullBit(c+545,(vlTOPp->reset));
        vcdp->fullBus(c+553,(0x10U),32);
        vcdp->fullBus(c+561,(0U),32);
        vcdp->fullBit(c+569,(0U));
        vcdp->fullBit(c+577,(vlTOPp->testbench__DOT__dut__DOT__alu_eq));
    }
}
