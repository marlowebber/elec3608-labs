...
const uint32_t _pyverilator_num_internal_signals = 25;
...
const uint32_t _pyverilator_internal_signal_widths[] = {5,7,1,1,1,1,5,1,13,32,32,32,32,32,32,32,32,32,32,21,32,32,32,32,32};
