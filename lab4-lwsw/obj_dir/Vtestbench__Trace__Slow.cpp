...
void Vtestbench::traceInitThis__1(Vtestbench__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->declBit(c+569,"clock", false,-1);
        vcdp->declBit(c+577,"reset", false,-1);
        vcdp->declBus(c+585,"testbench MEM_ADDR_WIDTH", false,-1, 31,0);
        vcdp->declBit(c+569,"testbench clock", false,-1);
        vcdp->declBit(c+577,"testbench reset", false,-1);
        ...
        vcdp->declBus(c+593,"testbench x10", false,-1, 31,0);
        ...
        vcdp->declBit(c+569,"testbench dut clock", false,-1);
        vcdp->declBit(c+577,"testbench dut reset", false,-1);
        vcdp->declBit(c+241,"testbench dut trap", false,-1);
        vcdp->declBus(c+593,"testbench dut x10", false,-1, 31,0);
        ...
        vcdp->declBus(c+257,"testbench dut d_rd", false,-1, 4,0);
        vcdp->declBus(c+265,"testbench dut d_x0", false,-1, 31,0);
        vcdp->declBus(c+273,"testbench dut d_x1", false,-1, 31,0);
        vcdp->declBus(c+281,"testbench dut d_x2", false,-1, 31,0);
        vcdp->declBus(c+289,"testbench dut d_x3", false,-1, 31,0);
        vcdp->declBus(c+297,"testbench dut d_x4", false,-1, 31,0);
        vcdp->declBus(c+305,"testbench dut d_opcode", false,-1, 6,0);
...
void Vtestbench::traceFullThis__1(Vtestbench__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+97,(((0xfe0U & (vlTOPp->testbench__DOT__imem_data 
                                        >> 0x14U)) 
        ...
        vcdp->fullBus(c+257,(vlTOPp->testbench__DOT__dut__DOT__d_rd),5);
        vcdp->fullBus(c+265,(vlTOPp->testbench__DOT__dut__DOT__d_x0),32);
        vcdp->fullBus(c+273,(vlTOPp->testbench__DOT__dut__DOT__d_x1),32);
        vcdp->fullBus(c+281,(vlTOPp->testbench__DOT__dut__DOT__d_x2),32);
        vcdp->fullBus(c+289,(vlTOPp->testbench__DOT__dut__DOT__d_x3),32);
        vcdp->fullBus(c+297,(vlTOPp->testbench__DOT__dut__DOT__d_x4),32);
        vcdp->fullBus(c+305,(vlTOPp->testbench__DOT__dut__DOT__d_opcode),7);
        ...
        vcdp->fullBit(c+569,(vlTOPp->clock));
        vcdp->fullBit(c+577,(vlTOPp->reset));
        vcdp->fullBus(c+585,(0x10U),32);
        vcdp->fullBus(c+593,(vlTOPp->testbench__DOT__x10),32);
